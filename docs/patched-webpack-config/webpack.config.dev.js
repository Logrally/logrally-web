...
// PATCHED
const ringConfig = require('@jetbrains/ring-ui/webpack.config');
...
module.exports = {
  ...
  module: {
    ...
    rules: [
      ...
      ...ringConfig.config.module.rules, // PATCHED
      {
        exclude: [
          /\.html$/,
          /\.(js|jsx)$/,
          ...
          /\.jpe?g$/,
          /\.png$/,
          /@jetbrains\/icons\/[a-zA-Z0-9_-]+\.svg$/,
        ],
      ...
      {
        test: /\.css$/,
        exclude: [ringConfig.componentsPath, /highlight.js/], // PATCHED!
        use: [
